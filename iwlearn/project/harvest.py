...
def get_ibrd_info(ibrd_id):
    ...
    """
    url = 'http://search.worldbank.org/api/v2/projects?fl=id,project_name,closingdate,countryname,location,project_abstract&rows=ALL&format=json&apilang=en&geocode=on&qterm=P%06i'
